    ...
    <main>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <a href="/research" className="block group">
          <div className="border border-gray-200 rounded-xl p-8 text-center transition hover:-translate-y-1">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="border border-gray-200 rounded-xl p-6 hover:-translate-y-1 transition">
            ...
            <p className="text-sm text-gray-600 mt-2">
              A diagnostic framework for identifying when LLMs rely on speculative reasoning under uncertainty.
            </p>
